    ...
    render() { 
        return ( <React.Fragment>
                ...
                <div className="home-slider owl-carousel owl-theme owl-carousel-lazy">
                    <div className="home-slide" 
                       style={{backgroundImage: "url('assets/images/slider/slide1.jpg')"}} >
                        <img className="owl-lazy" src="assets/images/lazy.png" alt="imss"/>
                        <div className="home-slide-content container">
                            <div>
                                ...
                                <h2 className="home-slide-foot">from <span>$499</span></h2>
                    ...
                    <div className="home-slide"  style={{backgroundImage: "url('assets/images/slider/slide3.jpg')"}}>
                        <img className="owl-lazy" src="assets/images/lazy.png" alt="imss"/>
                        <div className="home-slide-content container">
                            <div>
            ...
            <section className="categories-container">
                <div className="container categories-carousel owl-carousel owl-theme" data-toggle="owl" data-owl-options="{
                    'loop' : true,
                    'margin': 30,
                    'nav': false,
                    'dots': true,
                        ...
                        <div className="col-6 col-lg-2 col-md-3 col-sm-4 product-default inner-quickview inner-icon">
                            <figure>
                                <Link to="product.html">
                                    <img src="assets/images/products/product-20.jpg" alt="pogo"/>
                                </Link>
                ...
                <div className="container">
                    ...
                    <div className="product-intro divide-line mt-2 mb-8">
                        <div className="col-6 col-lg-2 col-md-3 col-sm-4 product-default inner-quickview inner-icon">
                            <figure>
                                <Link to="product.html">
                                    <img src="assets/images/products/product-7.jpg" alt="ss"/>
                                </Link>
                                <div className="btn-icon-group">
                                    <button className="btn-icon btn-add-cart" data-toggle="modal" data-target="#addCartModal"><i className="icon-bag"></i></button>
                                </div>
                        ...
                        <div className="col-6 col-lg-2 col-md-3 col-sm-4 product-default inner-quickview inner-icon">
                            <figure>
                                <Link to="product.html">
                                    <img src="assets/images/products/product-8.jpg" alt="ss" />
                                </Link>
                                <div className="btn-icon-group">
                                    <button className="btn-icon btn-add-cart" data-toggle="modal" data-target="#addCartModal"><i className="icon-bag"></i></button>
                                </div>
                        ...
                        <div className="col-6 col-lg-2 col-md-3 col-sm-4 product-default inner-quickview inner-icon">
                            <figure>
                                <Link to="product.html">
                                    <img src="assets/images/products/product-9.jpg" alt="ss" />
                                </Link>
                                <div className="btn-icon-group">
                                    <button className="btn-icon btn-add-cart" data-toggle="modal" data-target="#addCartModal"><i className="icon-bag"></i></button>
                                </div>
                        ...
                        <div className="col-6 col-lg-2 col-md-3 col-sm-4 product-default inner-quickview inner-icon">
                            <figure>
                                <Link to="product.html">
                                    <img src="assets/images/products/product-10.jpg" alt="ss" />
                                </Link>
                                <div className="btn-icon-group">
                                    <button className="btn-icon btn-add-cart" data-toggle="modal" data-target="#addCartModal"><i className="icon-bag"></i></button>
                                </div>
                        ...
                        <div className="col-6 col-lg-2 col-md-3 col-sm-4 product-default inner-quickview inner-icon">
                            <figure>
                                <Link to="product.html">
                                    <img src="assets/images/products/product-11.jpg" alt="ss" />
                                </Link>
                                <div className="btn-icon-group">
                                    <button className="btn-icon btn-add-cart" data-toggle="modal" data-target="#addCartModal"><i className="icon-bag"></i></button>
                                </div>
                        ...
                        <div className="col-6 col-lg-2 col-md-3 col-sm-4 product-default inner-quickview inner-icon">
                            <figure>
                                <Link to="product.html">
                                    <img src="assets/images/products/product-12.jpg" alt="ss" />
                                </Link>
                                <div className="btn-icon-group">
                                    <button className="btn-icon btn-add-cart" data-toggle="modal" data-target="#addCartModal"><i className="icon-bag"></i></button>
                                </div>
