                ...
                <div className="row">
                            ...
                            <table className="table table-cart">
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="4" className="clearfix">
                                            <div className="float-left">
                                                <Link to="category.html" className="btn btn-outline-secondary">Continue Shopping</Link>
                                            </div>{/* End .float-left */}

                                            <div className="float-right">
                                                <Link to="#/" className="btn btn-outline-secondary btn-clear-cart">Clear Shopping Cart</Link>
                    ...
                    <div className="col-lg-4">
                        <div className="cart-summary">
                            ...
                            <h4>
                                <Link data-toggle="collapse" to="#total-estimate-section" className="collapsed" role="button" aria-expanded="false" aria-controls="total-estimate-section">Estimate Shipping and Tax</Link>
                            </h4>
                            ...
                            <div className="checkout-methods">
                                <Link to="checkout-shipping.html" className="btn btn-block btn-sm btn-primary">Go to Checkout</Link>
                                <Link to="#/" className="btn btn-link btn-block">Check Out with Multiple Addresses</Link>
